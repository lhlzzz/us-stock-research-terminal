...
- output_date: 2026-06-21-final-v2
...
- artifact_summary: /root/hermes/company-ai-system/workspaces/xiaomei/research/profit-ticket-pipeline/summary-2026-06-21-final-v2.md
- artifact_metrics: /root/hermes/company-ai-system/workspaces/xiaomei/research/profit-ticket-pipeline/metrics-2026-06-21-final-v2.json
- artifact_candidates: /root/hermes/company-ai-system/workspaces/xiaomei/research/profit-ticket-pipeline/candidates-2026-06-21-final-v2.csv
- artifact_forward_tracking: /root/hermes/company-ai-system/workspaces/xiaomei/research/profit-ticket-pipeline/forward-tracking-2026-06-21-final-v2.csv
- artifact_runtime_context: /root/hermes/company-ai-system/workspaces/xiaomei/research/profit-ticket-pipeline/runtime-decision-context-2026-06-21-final-v2.json
...
|---|---|---|---|---|---|---|---|---|---|---|---|
|1|SW|Smurfit WestRock plc|44.2|0.017964071856287456|1.7261073237406777e-08|0.7890838206627682|0.525|1.3640838206627681|found_relevant|found_relevant|CANDIDATE_FOR_PAPER_REVIEW|
...
|2|GE|GE航空航天|357.64|0.0017085398986080857|4.095860894892667e-08|0.784307992202729|0.525|1.359307992202729|found_relevant|found_relevant|CANDIDATE_FOR_PAPER_REVIEW|
  - ticket_card: research_only=true allow_trade=false auto_order=false no_broker_api=true
  - lifecycle_stage: paper_review_candidate
  - kline_source: Yahoo Finance historical kline
  - quote_source: EastMoney US realtime/delayed quote + kline | status=ok | prev_close=357.03 | cross_check_basis=latest_price | gap=4.095860894892667e-08 | mismatch=false
  ...
  - catalyst: I'm Calling It: GE Vernova (GEV) Is a Buy Before This Catalyst Drops; Is GE Stock's Large Backlog Enough To Out-Fly a Slowdown?
...
|4|TECH|Bio-Techne Corp|57.94|0.05345454545454542|2.3701951068488825e-08|0.8030214424951266|0.475|1.3280214424951267|found_relevant|found_relevant|CANDIDATE_FOR_PAPER_REVIEW|
  - ticket_card: research_only=true allow_trade=false auto_order=false no_broker_api=true
  - lifecycle_stage: paper_review_candidate
  - kline_source: Yahoo Finance historical kline
  ...
  - catalyst: Micron is on an absolute TEAR this morning. How do you find these stocks before they blow up?; 3 Reasons TECH is Risky and 1 Stock to Buy Instead
|5|TER|泰瑞达|437.92|0.07186214999020946|3.0662527295000075e-08|0.8110136452241714|0.425|1.2560136452241715|found_relevant|found_relevant|CANDIDATE_FOR_PAPER_REVIEW|
  - ticket_card: research_only=true allow_trade=false auto_order=false no_broker_api=true
  - lifecycle_stage: paper_review_candidate
  - kline_source: Yahoo Finance historical kline
...
- top_shared_titles: [["Assessing Smurfit Westrock (SW) Valuation After Recent Mixed Share Performance", 1], ["Smurfit WestRock PLC (SW): Best Stock to Buy According to George Soros", 1], ["I'm Calling It: GE Vernova (GEV) Is a Buy Before This Catalyst Drops", 1], ["Is GE Stock's Large Backlog Enough To Out-Fly a Slowdown?", 1], ["Moderna Has Some Key Approvals Ahead. Is the Stock a Buy?", 1]]
...
### GE: WATCH (red=0, yellow=2)
  ...
  - intraday_gap: [GREEN] intraday_pct_chg=0.17%
  - liquidity: [GREEN] amount=2,785,748,480
  - valuation: [GREEN] pe_ttm=20.66
  - quality_gap: [GREEN] roe=1037.00%
  - price_manipulation: [YELLOW] 5d_accel=-0.1167
  - news_red_flags: [GREEN] narrative_status=found_relevant
  - supply_chain_risk: [GREEN] business_status=found_relevant
  - short_interest: [GREEN] provider_field_unavailable
  - dilution_risk: [GREEN] provider_field_unavailable
...
|TECH|4|1d|2026-06-19|pending|
|TECH|4|3d|2026-06-23|pending|
|TECH|4|5d|2026-06-25|pending|
|TECH|4|10d|2026-07-02|pending|
|TER|5|1d|2026-06-19|pending|
|TER|5|3d|2026-06-23|pending|
|TER|5|5d|2026-06-25|pending|
|TER|5|10d|2026-07-02|pending|
